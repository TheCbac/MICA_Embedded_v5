...
* 
* Brief:
*   *** DEPRECATED - NO LONGER ACTIVE SINCE PORTING TO MICA IMU ***
...
*
* Summary:
*   Transmits the header for the project 
*
* Parameters:
*   None
*
...
void PrintHeader(void){
    DBG_PRINT("\r\n\r\n");
    DBG_PRINT("|==================================================|\r\n");
    DBG_PRINT("|    MICA OTA BLE Stack Example                    |\r\n");
    DBG_PRINT("|    Version: v1.0.0                               |\r\n");
    DBG_PRINT("|    Compile Date and Time: " __DATE__ " " __TIME__ "   |\r\n");
    DBG_PRINT("|==================================================|\r\n");
